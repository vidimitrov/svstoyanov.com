...
export const Hatchery1 = {
  ...
  shortDescription: 'Trading and portfolio management changed after 2014 after cryptocurrencies came on the stage for the mainstream customer. A different way needs to be provided to those customers.',
  logo: null,
  metadata: {
    duration: '2_MONTHS',
  },
...
export const MotelNow = {
  ...
  sections: [{
    ...
    type: TYPES.Text,
    content: 'Recently spoke with the team and made a review of their first launch, some parts are stripped but because time is of essense and those parts will be added afterwards.',
  }, {
    type: TYPES.CTA,
    URL: 'https://motelnow.cl/',
    buttonText: 'VISIT MOTELNOW',
  }, {
    type: TYPES.Review,
